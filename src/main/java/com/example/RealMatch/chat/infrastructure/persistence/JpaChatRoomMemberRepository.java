...
import com.example.RealMatch.chat.application.repository.ChatRoomMemberRepositoryCustom;
import com.example.RealMatch.chat.domain.entity.ChatRoomMember;

public interface JpaChatRoomMemberRepository extends JpaRepository<ChatRoomMember, Long>, ChatRoomMemberRepository, ChatRoomMemberRepositoryCustom {
    ...
    @Query("""
            ...
            SET m.lastReadMessageId = :messageId,
                m.lastReadAt = :readAt
            WHERE m.id = :memberId AND m.leftAt IS NULL AND m.isDeleted = false
